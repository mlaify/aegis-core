...
## Repo-specific notes
- This repo contains shared Rust crates only.
- Do not add app/server binaries here.
- Keep demo crypto isolated from future PQ integration.
- Public types should remain serialization-stable where possible.
